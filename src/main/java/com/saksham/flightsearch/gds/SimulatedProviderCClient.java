...
/**
 * Simulated GDS source "C". Generates a small, deterministic-ish set of
 * offers per route/date so repeated searches are cacheable and testable.
 */
@Component
public class SimulatedProviderCClient implements GdsProviderClient {

    private static final String PROVIDER_NAME = "PROVIDER_C";
